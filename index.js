...
const Rental = sequelize.define('Rental', {
    rental_id: {
        type: Sequelize.UUID,  // ใช้ UUID สำหรับ ID ที่ไม่ซ้ำ
        defaultValue: Sequelize.UUIDV4,  // ให้ UUID เป็นค่าเริ่มต้น
        primaryKey: true
    },
    start_data: {
        type: Sequelize.DATE,
        allowNull: false,
        defaultValue: Sequelize.NOW,  // กำหนดวันที่เริ่มต้นเป็นวันและเวลาปัจจุบัน
    },
    end_data: {
        type: Sequelize.DATE,
        allowNull: false
    ...
    status: {
        type: Sequelize.INTEGER,  // ใช้ INTEGER สำหรับสถานะ
        allowNull: false
    },
    users_id: {
